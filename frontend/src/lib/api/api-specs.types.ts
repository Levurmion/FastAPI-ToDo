...
export interface paths {
    ...
    "/likes/post/{post_id}": {
        /** Like A Post */
        post: operations["like_a_post_likes_post__post_id__post"];
        /** Remove Like From A Post */
        delete: operations["remove_like_from_a_post_likes_post__post_id__delete"];
    };
    "/": {
        /** Ping */
...
export interface operations {
    ...
    /** Like A Post */
    like_a_post_likes_post__post_id__post: {
        parameters: {
            path: {
                post_id: number;
            };
    ...
    /** Remove Like From A Post */
    remove_like_from_a_post_likes_post__post_id__delete: {
        parameters: {
            path: {
                post_id: number;
            };
